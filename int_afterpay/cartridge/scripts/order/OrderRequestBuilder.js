...
(function () {
    ...
    var AfterpayWebServiceUtilities = require('~/cartridge/scripts/util/AfterpayUtilities');
    ...
    */
    ...
    OrderRequestBuilder.prototype.buildMerchantInformation = function (url) {
        //this.context.merchantReference = dw.order.OrderMgr.createOrderNo();
    ...
    function buildAddress(type, address) {
        ...
        this.context[type].suburb = address.address1 || '';
